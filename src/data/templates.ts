...
import { EXTENDED_SEEDS, ExtendedCategory } from "./extendedSeeds";
import { buildTemplateCover } from "../lib/templateCover";
...
export const CATEGORY_KEYS: CategoryKey[] = ["birthday", "sunatan", "wedding", "aqiqah", "education", "religious", "tasyakuran", "gathering", "business", "anniversary", "family", "doa-haul"];
...
const IMAGE_POOLS: Record<CategoryKey, string[]> = {
  ...
  religious: [
    ...
    "https://images.unsplash.com/photo-1516924962504-1b5d7fa246b9?auto=format&fit=crop&w=600&q=80",
    ...
    "https://images.unsplash.com/photo-1517849845537-4d257902454a?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1517486800575-9e0f7fa53d7f?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1469306072984-4f2c6d99fb01?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=600&q=80",
  ...
  tasyakuran: [
    ...
    "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1517849845537-4d257902454a?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1519331379826-f10be5486c6d?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1544415033-29406be6e3eb?auto=format&fit=crop&w=600&q=80",
  ...
  family: [
    ...
    "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1518929458114-2431f33f0ca5?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=600&q=80",
  ...
  "doa-haul": [
    ...
    "https://images.unsplash.com/photo-1517849845537-4d257902454a?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1523626797181-8c5f1d9f9f53?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1517486800575-9e0f7fa53d7f?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1516924962504-1b5d7fa246b9?auto=format&fit=crop&w=600&q=80",
    "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=600&q=80",
...
const GALLERY_POOLS: Record<CategoryKey, string[]> = {
  ...
  religious: ["https://images.unsplash.com/photo-1542816417-0983c9c9ad53?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1519817650390-64a93db51149?auto=format&fit=crop&w=600&q=80"],
  tasyakuran: ["https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=600&q=80"],
  gathering: ["https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=600&q=80"],
  business: ["https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1531545514256-b1400bc00f31?auto=format&fit=crop&w=600&q=80"],
  anniversary: ["https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=600&q=80"],
  family: ["https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1544415033-29406be6e3eb?auto=format&fit=crop&w=600&q=80"],
  "doa-haul": ["https://images.unsplash.com/photo-1519817650390-64a93db51149?auto=format&fit=crop&w=600&q=80", "https://images.unsplash.com/photo-1542816417-0983c9c9ad53?auto=format&fit=crop&w=600&q=80"],
};
...
/* ---- Extended category detail pools ---- */
const RELIGIOUS_VENUES = [
  { venue: "Masjid Agung Al-Azhar", address: "Jl. Sisingamangaraja No.1, Jakarta Selatan" },
  { venue: "Masjid Istiqlal Hall", address: "Jl. Taman Wijaya Kusuma, Jakarta Pusat" },
  { venue: "Masjid Raya Al-Jabbar", address: "Jl. Cimincrang, Bandung, Jawa Barat" },
  { venue: "Islamic Center Hall", address: "Jl. Boulevard Barat Raya, Kelapa Gading" },
  { venue: "Masjid Baitul Ilmi", address: "Jl. Raya Cilandak, Jakarta Selatan" },
  { venue: "Aula Masjid Raya Baiturrahman", address: "Jl. Syeikh Nawawi, Bogor" },
];
const RELIGIOUS_TITLES = ["Kajian", "Majelis Taklim", "Peringatan Maulid", "Isra Mi'raj", "Tabligh Akbar", "Pengajian Akbar"];
const USTADZ_NAMES = ["Ustadz Abdul Somad", "Ustadz Adi Hidayat", "Ustadz Hanan Attaki", "Ustadz Khalid Basalamah", "Ustadzah Oki Setiana Dewi", "Ustadz Syafiq Riza Basalamah", "Ustadz Das'ad Latif", "Ustadzah Halimah Alaydrus"];

const TASYAKURAN_TITLES = ["Syukuran Rumah Baru", "Tasyakuran Keluarga", "Syukuran Kelahiran", "Selamatan", "Ngunduh Mantu", "Syukuran Panen", "Syukuran Usaha", "Syukuran Wisuda"];
const HOST_FAMILIES = [
  "Keluarga Bapak Rudi Santoso",
  "Keluarga Bapak Hendra Wijaya",
  "Keluarga Bapak Agus Firmansyah",
  "Keluarga Bapak Budi Hartono",
  "Keluarga Bapak Joko Prasetyo",
  "Keluarga Bapak Andi Saputra",
  "Keluarga Bapak Dedi Kurniawan",
  "Keluarga Bapak Eko Nugroho",
];
const HOME_VENUES = [
  { venue: "Kediaman Keluarga", address: "Jl. Anggrek No. 8, Depok" },
  { venue: "Rumah Kediaman", address: "Jl. Melati Indah No. 12, Bekasi" },
  { venue: "Kediaman Orang Tua", address: "Jl. Mawar Indah No. 21, Tangerang" },
  { venue: "Halaman Rumah", address: "Jl. Kenanga No. 5, Jakarta Timur" },
  { venue: "Rumah Mertua", address: "Jl. Cempaka Putih No. 3, Jakarta Pusat" },
  { venue: "Aula RT / RW", address: "Jl. Kramat Jaya No. 45, Jakarta Utara" },
];

const GATHERING_TITLES = ["Family Gathering", "Reuni Akbar", "Arisan", "Kopdar Komunitas", "Annual Dinner", "Weekend Market", "Bakti Sosial", "Team Building"];
const GATHERING_ORGANIZERS = ["Panitia Reuni '86", "Paguyuban Warga", "Komunitas Nusantara", "Badan Pengurus Arisan", "HR Department", "Keluarga Besar An-Nur", "Panitia HUT Kota", "Komunitas Roda Dua"];
const GATHERING_VENUES = [
  { venue: "Taman Mini Indonesia Indah", address: "Jl. Raya TMII, Jakarta Timur" },
  { venue: "Lapangan Merdeka", address: "Jl. Medan Merdeka, Jakarta Pusat" },
  { venue: "The Garden Resto", address: "Jl. Boulevard Barat Raya, Kelapa Gading" },
  { venue: "Bumi Perkemahan Cibubur", address: "Jl. Raya Bogor KM 36, Jakarta Timur" },
  { venue: "Aula Balai Warga", address: "Jl. Kemanggisan No. 17, Jakarta Barat" },
  { venue: "Pantai Indah Kapuk Area", address: "Jl. Marina Raya, Jakarta Utara" },
];

const COMPANY_NAMES = ["PT Nusantara Digital Kreatif", "PT Sinar Harapan Indonesia", "PT Bumi Nusantara Group", "PT Cahaya Teknologi Mandiri", "CV Karya Gemilang", "PT Rindu Group", "PT Prima Sejahtera", "PT Global Mandiri Utama"];
const BUSINESS_TITLES = ["Grand Opening", "Product Launching", "Seminar Nasional", "Workshop", "Annual Meeting", "Business Expo", "Award Ceremony", "Networking Night"];
const BUSINESS_VENUES = [
  { venue: "The Ritz-Carlton Ballroom", address: "Mega Kuningan Lot 1.1, Jakarta Selatan" },
  { venue: "Balai Kartini", address: "Jl. Gatot Subroto No.37, Jakarta Selatan" },
  { venue: "Jakarta Convention Center", address: "Jl. Jend. Gatot Subroto, Jakarta Pusat" },
  { venue: "Hotel Borobudur Ballroom", address: "Jl. Lapangan Banteng Selatan, Jakarta Pusat" },
  { venue: "The Westin Ballroom", address: "Jl. M.H. Thamrin No.1, Jakarta Pusat" },
  { venue: "Rooftop Venue Senayan", address: "Jl. Asia Afrika No.1, Senayan, Jakarta" },
];

const ANNIVERSARY_COUPLES = ["Bapak & Ibu", "Rian & Maya", "Arief & Dinda", "Rizky & Nadia", "Bima & Sarah", "Fajar & Putri", "Gilang & Aisyah", "Reza & Salsabila"];
const ANNIVERSARY_TITLES = ["Anniversary Ke-1", "Anniversary Ke-5", "Anniversary Ke-10", "Anniversary Ke-25", "Anniversary Ke-50", "Romantic Dinner", "Renewal Vows", "Milestone Love"];
const ANNIVERSARY_VENUES = [
  { venue: "The Glass House Garden Resto", address: "Jl. Boulevard Barat Raya, Kelapa Gading" },
  { venue: "Skyline Rooftop Lounge", address: "Jl. Asia Afrika No.1, Senayan, Jakarta" },
  { venue: "Garden Pavilion Dharmawangsa", address: "Jl. Brawijaya Raya No.26, Jakarta Selatan" },
  { venue: "Pantai Indah Kapuk Sunset Area", address: "Jl. Marina Indah, Jakarta Utara" },
  { venue: "Bandung City View Lounge", address: "Jl. Braga No. 10, Bandung" },
  { venue: "Rumah Kediaman", address: "Jl. Cempaka Putih No. 8, Jakarta Pusat" },
];

const FAMILY_TITLES = ["Kumpul Keluarga", "Reuni Keluarga", "Halal Bihalal", "Family Day", "Arisan Keluarga", "Open House", "Lebaran Bersama", "Liburan Keluarga"];
const FAMILY_VENUES = [
  { venue: "Kediaman Keluarga Besar", address: "Jl. Kenanga No. 5, Jakarta Timur" },
  { venue: "Rumah Mertua", address: "Jl. Melati Indah No. 12, Bekasi" },
  { venue: "Kampung Halaman", address: "Jl. Raya Cibubur KM 12, Jakarta Timur" },
  { venue: "Aula Rumah Orang Tua", address: "Jl. Mawar Indah No. 21, Tangerang" },
  { venue: "Lapangan Desa", address: "Jl. Desa Sukamaju, Bogor" },
  { venue: "Rumah Nenek", address: "Jl. Anggrek No. 8, Depok" },
];

const DECEASED_NAMES = ["Bapak H. Ahmad Soleh", "Ibu Hj. Siti Aminah", "Bapak K.H. Muhammad Nur", "Ibu Hj. Maryam", "Bapak Rudi Santoso", "Ibu Dewi Lestari", "Bapak H. Abdul Rahman", "Ibu Hj. Fatimah"];
const HAUL_TITLES = ["Tahlilan", "Peringatan Haul", "Doa Bersama", "Yasinan", "Istighotsah Doa", "Peringatan Wafat", "Ziarah Kubur", "Doa Arwah"];

const buildExtendedDetails = (category: ExtendedCategory, idx: number, portrait: string): EventDetails => {
  ...
  switch (category) {
    case "religious": {
      const venue = pick(RELIGIOUS_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(RELIGIOUS_TITLES, idx),
        hostName: pick(USTADZ_NAMES, idx),
        institutionName: pick(HOST_FAMILIES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: "Dan tidaklah Kami menurunkan Al-Qur'an itu melainkan untuk memberi petunjuk kepada manusia.",
      };
    }
    case "tasyakuran": {
      const venue = pick(HOME_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(TASYAKURAN_TITLES, idx),
        hostName: pick(HOST_FAMILIES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Jika kamu bersyukur, niscaya Aku akan menambah (nikmat) kepadamu."',
      };
    }
    case "gathering": {
      const venue = pick(GATHERING_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(GATHERING_TITLES, idx),
        hostName: pick(GATHERING_ORGANIZERS, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Kebersamaan adalah pelengkap terbaik untuk kebahagiaan."',
      };
    }
    case "business": {
      const venue = pick(BUSINESS_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(BUSINESS_TITLES, idx),
        companyName: pick(COMPANY_NAMES, idx),
        hostName: pick(COMPANY_NAMES, idx),
        institutionName: pick(COMPANY_NAMES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Great things in business are never done by one person. They are done by a team."',
      };
    }
    case "anniversary": {
      const venue = pick(ANNIVERSARY_VENUES, idx);
      const years = [1, 5, 10, 25, 50, 2, 3, 7][idx % 8];
      return {
        ...base,
        eventTitle: pick(ANNIVERSARY_TITLES, idx),
        coupleName: pick(ANNIVERSARY_COUPLES, idx),
        anniversaryYear: years,
        hostName: pick(ANNIVERSARY_COUPLES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Bersamamu, setiap hari adalah perayaan cinta."',
        hashtag: "#ForeverUs",
      };
    }
    case "family": {
      const venue = pick(FAMILY_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(FAMILY_TITLES, idx),
        hostName: pick(HOST_FAMILIES, idx),
        institutionName: pick(HOST_FAMILIES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Rumah adalah tempat berbagi cerita dan cinta tanpa syarat."',
      };
    }
    case "doa-haul": {
      const venue = pick(RELIGIOUS_VENUES, idx);
      return {
        ...base,
        eventTitle: pick(HAUL_TITLES, idx),
        deceasedName: pick(DECEASED_NAMES, idx),
        hostName: pick(HOST_FAMILIES, idx),
        venue: venue.venue,
        address: venue.address,
        messageQuote: '"Innalillahi wa inna ilaihi raji\'un. Semoga arwahnya diterima di sisi Allah SWT."',
...
const ALL_SEEDS: Record<CategoryKey, Seed[]> = {
  ...
  religious: EXTENDED_SEEDS.religious,
  tasyakuran: EXTENDED_SEEDS.tasyakuran,
  gathering: EXTENDED_SEEDS.gathering,
  business: EXTENDED_SEEDS.business,
  anniversary: EXTENDED_SEEDS.anniversary,
  family: EXTENDED_SEEDS.family,
  "doa-haul": EXTENDED_SEEDS["doa-haul"],
};
...
const buildThemeStyle = (category: CategoryKey, seed: Seed, idx: number): ThemeStyle => {
  ...
  const palette =
    PALETTES[palKey] ||
    pick(
      FALLBACK_PALETTES[category].map((k) => PALETTES[k]),
      idx,
    );
  ...
  CATEGORY_KEYS.forEach((catKey) => {
    ...
    seeds.forEach((seed, i) => {
      ...
      const palette =
        PALETTES[seed[3]] ||
        pick(
          FALLBACK_PALETTES[catKey].map((k) => PALETTES[k]),
          i,
        );
...
export const getCategoryCount = (category: string): number => TEMPLATES.filter((t) => t.category === category).length;
