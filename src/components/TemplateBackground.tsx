...
export const TemplateBackground: React.FC<TemplateBackgroundProps> = ({ themeStyle, children }) => {
  ...
  return (
    ...
    >
      ...
      {(bgType === 'celebration-confetti' || pattern.includes('balloons') || pattern.includes('confetti') || pattern.includes('party')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          {/* Confetti Polka Dots */}
      ...
      {(bgType === 'kids-adventure' || pattern.includes('clouds') || pattern.includes('dinosaur') || pattern.includes('space')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
      ...
      {(bgType === 'neon-glow' || pattern.includes('neon') || pattern.includes('cyber')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          {/* Cyber Grid */}
      ...
      {(bgType === 'marble-gold' || bgType === 'luxury-emerald' || pattern.includes('gold') || pattern.includes('emerald') || pattern.includes('marble')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
      ...
      {(bgType === 'pastel-clouds' || pattern.includes('pastel') || pattern.includes('hearts')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
      ...
      {(bgType === 'wedding-royal' || pattern.includes('royal')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
