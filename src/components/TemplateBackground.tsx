    ...
    >
      ...
      {(bgType === 'celebration-confetti' || pattern.includes('balloons')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[50%] left-[8%] text-3xl sm:text-4xl animate-float-up opacity-80 select-none">🎉</div>
          <div className="absolute top-[72%] right-[10%] text-4xl sm:text-5xl animate-float-up animation-delay-2000 opacity-85 select-none">🎁</div>
          <div className="absolute top-[18%] right-[16%] text-2xl sm:text-3xl animate-twinkle opacity-80 select-none">⭐</div>
          <div className="absolute top-[42%] left-[14%] text-2xl sm:text-3xl animate-twinkle opacity-85 select-none">🎂</div>
          <div className="absolute top-[88%] left-[10%] text-3xl sm:text-4xl animate-twinkle opacity-80 select-none">✨</div>
        </div>
      )}
      ...
      {(bgType === 'kids-adventure' || pattern.includes('clouds') || pattern.includes('dinosaur')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[32%] left-[6%] text-2xl animate-twinkle opacity-75 select-none">✨</div>
          <div className="absolute top-[52%] right-[12%] text-4xl animate-float-up opacity-85 select-none">🚀</div>
          <div className="absolute top-[74%] left-[8%] text-3xl animate-twinkle opacity-80 select-none">🌙</div>
          <div className="absolute top-[90%] right-[8%] text-4xl animate-twinkle opacity-90 select-none">☁️</div>
        </div>
      )}
      ...
      {(bgType === 'comic-doodles' || pattern.includes('cartoon') || pattern.includes('comic')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[52%] left-[10%] text-3xl animate-float-up opacity-80 select-none">🍿</div>
          <div className="absolute top-[75%] right-[8%] text-4xl animate-twinkle opacity-85 select-none">🎪</div>
        </div>
      )}
      ...
      {(bgType === 'neon-glow' || pattern.includes('neon-grid')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[28rem] h-[28rem] bg-gradient-to-tr from-cyan-500/25 to-fuchsia-500/25 rounded-full blur-3xl animate-neon-pulse" />
          ...
          <div className="absolute top-[65%] left-[12%] text-3xl animate-twinkle opacity-85 select-none">🌌</div>
          <div className="absolute top-[88%] right-[12%] text-3xl animate-float-up opacity-80 select-none">💿</div>
        </div>
      )}
      ...
      {(bgType === 'floral-lace' || pattern.includes('floral') || pattern.includes('butterfly') || pattern.includes('rose-gold')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[48%] right-[10%] text-2xl sm:text-3xl animate-float-up animation-delay-2000 opacity-85 select-none">👑</div>
          <div className="absolute top-[68%] left-[10%] text-3xl sm:text-4xl animate-twinkle opacity-90 select-none">✨</div>
          <div className="absolute top-[88%] right-[8%] text-3xl sm:text-4xl animate-float-up opacity-90 select-none">🌸</div>
        </div>
      )}
      ...
      {(bgType === 'marble-gold' || bgType === 'luxury-emerald' || pattern.includes('emerald') || pattern.includes('marble')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[50%] left-[8%] text-2xl sm:text-3xl animate-twinkle text-amber-300 opacity-90 select-none">💎</div>
          <div className="absolute top-[70%] right-[10%] text-3xl sm:text-4xl animate-twinkle text-amber-200 opacity-90 select-none">🥂</div>
          <div className="absolute top-[88%] left-[10%] text-2xl sm:text-3xl animate-twinkle text-amber-300 opacity-85 select-none">✨</div>
        </div>
      )}
      ...
      {(bgType === 'pastel-clouds' || pattern.includes('hearts')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[55%] left-[10%] text-3xl animate-float-up opacity-85 select-none">💖</div>
          <div className="absolute top-[78%] right-[8%] text-4xl animate-twinkle opacity-90 select-none">☁️</div>
          <div className="absolute top-[92%] left-[14%] text-3xl animate-float-up opacity-80 select-none">🎀</div>
        </div>
      )}
      ...
      {(bgType === 'minimalist-lines' || pattern.includes('minimalist') || pattern.includes('monochrome')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[75%] left-[12%] text-2xl animate-twinkle opacity-60 select-none">🌿</div>
        </div>
      )}
      ...
      {(bgType === 'wine-jazz' || pattern.includes('wine') || pattern.includes('jazz')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[75%] left-[12%] text-3xl animate-twinkle opacity-80 select-none">🥂</div>
        </div>
      )}
      ...
      {(bgType === 'islamic-gold' || pattern.includes('islamic') || pattern.includes('arabesque') || pattern.includes('mosque')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[48%] left-[8%] text-3xl sm:text-4xl animate-twinkle text-amber-300 opacity-90 select-none">🌙</div>
          <div className="absolute top-[70%] right-[10%] text-3xl sm:text-4xl animate-twinkle text-amber-200 opacity-90 select-none">✨</div>
          <div className="absolute top-[88%] left-[10%] text-2xl sm:text-3xl animate-twinkle text-amber-300 opacity-85 select-none">⭐</div>
        </div>
      )}
      ...
      {(bgType === 'wedding-garden' || pattern.includes('garden') || pattern.includes('wedding')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[10%] left-[8%] text-3xl sm:text-4xl animate-float-up opacity-85 select-none">🌷</div>
          <div className="absolute top-[30%] right-[10%] text-3xl animate-twinkle opacity-90 select-none">💐</div>
          <div className="absolute top-[52%] left-[10%] text-3xl animate-float-up opacity-85 select-none">💍</div>
          <div className="absolute top-[74%] right-[8%] text-3xl animate-twinkle opacity-90 select-none">🌿</div>
          <div className="absolute top-[90%] left-[12%] text-3xl animate-float-up opacity-80 select-none">🥂</div>
        </div>
      )}
      ...
      {(bgType === 'baby-moon' || pattern.includes('moon') || pattern.includes('crescent')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[32%] right-[8%] text-2xl animate-twinkle opacity-75 select-none">✨</div>
          <div className="absolute top-[52%] left-[6%] text-4xl animate-float-up opacity-85 select-none">☁️</div>
          <div className="absolute top-[74%] right-[10%] text-3xl animate-twinkle opacity-80 select-none">⭐</div>
          <div className="absolute top-[90%] left-[10%] text-4xl animate-float-up opacity-90 select-none">☁️</div>
        </div>
      )}
      ...
      {(bgType === 'baby-animal' || pattern.includes('animal') || pattern.includes('teddy')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[56%] left-[10%] text-3xl animate-float-up opacity-85 select-none">🍼</div>
          <div className="absolute top-[80%] right-[8%] text-3xl animate-twinkle opacity-85 select-none">🐻</div>
        </div>
      )}
      ...
      {(bgType === 'watercolor' || pattern.includes('watercolor')) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          <div className="absolute top-[12%] left-[6%] w-40 h-40 rounded-full bg-purple-400/20 blur-3xl animate-pulse" />
          <div className="absolute top-[40%] right-[6%] w-48 h-48 rounded-full bg-pink-400/20 blur-3xl animate-pulse" />
          <div className="absolute bottom-[12%] left-[20%] w-44 h-44 rounded-full bg-sky-400/20 blur-3xl animate-pulse" />
        </div>
      )}
      ...
      {bgType === 'balloon-party' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[55%] left-[7%] text-3xl sm:text-4xl animate-float-up animation-delay-2000 opacity-85 select-none">🎉</div>
          <div className="absolute top-[76%] right-[10%] text-4xl sm:text-5xl animate-float-up opacity-90 select-none">🎈</div>
          <div className="absolute top-[16%] right-[18%] text-2xl animate-twinkle opacity-80 select-none">⭐</div>
          <div className="absolute top-[66%] left-[18%] text-2xl animate-twinkle opacity-80 select-none">🎂</div>
        </div>
      )}
      ...
      {bgType === 'space-cosmic' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[46%] left-[8%] text-2xl animate-twinkle opacity-75 select-none">✨</div>
          <div className="absolute top-[64%] right-[8%] text-3xl animate-twinkle opacity-85 select-none">🌙</div>
          <div className="absolute top-[84%] left-[12%] text-3xl animate-twinkle opacity-90 select-none">🪐</div>
        </div>
      )}
      ...
      {bgType === 'princess-royal' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[52%] right-[10%] text-2xl sm:text-3xl animate-twinkle opacity-85 select-none">✨</div>
          <div className="absolute top-[72%] left-[10%] text-3xl sm:text-4xl animate-float-up opacity-90 select-none">🦋</div>
          <div className="absolute top-[88%] right-[12%] text-2xl animate-twinkle opacity-80 select-none">💖</div>
        </div>
      )}
      ...
      {bgType === 'candy-sweet' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[54%] left-[8%] text-3xl animate-float-up opacity-85 select-none">🌈</div>
          <div className="absolute top-[76%] right-[10%] text-3xl animate-twinkle opacity-90 select-none">🍩</div>
          <div className="absolute top-[90%] left-[14%] text-2xl animate-float-up opacity-85 select-none">🎀</div>
        </div>
      )}
      ...
      {bgType === 'confetti-burst' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[56%] left-[10%] text-3xl animate-twinkle opacity-85 select-none">✨</div>
          <div className="absolute top-[78%] right-[10%] text-4xl animate-float-up opacity-90 select-none">🎈</div>
        </div>
      )}
      ...
      {bgType === 'pastel-cute' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          <div className="absolute top-[10%] left-[8%] text-4xl animate-float-up opacity-85 select-none">☁️</div>
          <div className="absolute top-[30%] right-[10%] text-3xl animate-twinkle opacity-90 select-none">🦄</div>
          <div className="absolute top-[54%] left-[10%] text-3xl animate-float-up opacity-85 select-none">💖</div>
          <div className="absolute top-[76%] right-[8%] text-4xl animate-twinkle opacity-90 select-none">🌸</div>
          <div className="absolute top-[90%] left-[14%] text-3xl animate-float-up opacity-80 select-none">🎀</div>
        </div>
      )}
      ...
      {bgType === 'retro-pop' && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 deco-fade-in">
          ...
          <div className="absolute top-[12%] left-[8%] text-3xl sm:text-4xl animate-twinkle opacity-90 select-none">📼</div>
          <div className="absolute top-[34%] right-[8%] text-3xl animate-float-up opacity-85 select-none">💿</div>
          <div className="absolute top-[58%] left-[10%] text-3xl animate-twinkle opacity-85 select-none">🌶</div>
          <div className="absolute top-[80%] right-[10%] text-3xl sm:text-4xl animate-float-up opacity-90 select-none">🎉</div>
        </div>
      )}
